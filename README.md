...
**Query workflow — full pipeline running successfully end to end, showing a real grounded, cited answer:**

![Query workflow with grounded answer](./assets/02_query_workflow_diagram.png)
